...
class RandomAgent(Agent):
    def __init__(self, envs,name,type, num_episodes, gamma, lr=0.1, anneal_lr_param=1.,
                 threshold_lr_anneal=100., evaluate_every_n_episodes=200):
        super(RandomAgent, self).__init__(envs,name,type, num_episodes, gamma, lr, anneal_lr_param,
